<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="家具编号" prop="jiajubianhao">
            <el-input v-model="ruleForm.jiajubianhao" 
                placeholder="家具编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiajubianhao" label="家具编号" prop="jiajubianhao">
              <el-input v-model="ruleForm.jiajubianhao" 
                placeholder="家具编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="家具类型" prop="jiajuleixing">
          <el-select :disabled="ro.jiajuleixing" v-model="ruleForm.jiajuleixing" placeholder="请选择家具类型">
            <el-option
                v-for="(item,index) in jiajuleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="家具类型" prop="jiajuleixing">
	      <el-input v-model="ruleForm.jiajuleixing"
                placeholder="家具类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家具品牌" prop="jiajupinpai">
          <el-input v-model="ruleForm.jiajupinpai" 
              placeholder="家具品牌" clearable  :readonly="ro.jiajupinpai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家具品牌" prop="jiajupinpai">
              <el-input v-model="ruleForm.jiajupinpai" 
                placeholder="家具品牌" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家具规格" prop="jiajuguige">
          <el-input v-model="ruleForm.jiajuguige" 
              placeholder="家具规格" clearable  :readonly="ro.jiajuguige"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家具规格" prop="jiajuguige">
              <el-input v-model="ruleForm.jiajuguige" 
                placeholder="家具规格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jiajutupian" label="家具图片" prop="jiajutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jiajutupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家具颜色" prop="jiajuyanse">
          <el-input v-model="ruleForm.jiajuyanse" 
              placeholder="家具颜色" clearable  :readonly="ro.jiajuyanse"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家具颜色" prop="jiajuyanse">
              <el-input v-model="ruleForm.jiajuyanse" 
                placeholder="家具颜色" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家具材料" prop="jiajucailiao">
          <el-input v-model="ruleForm.jiajucailiao" 
              placeholder="家具材料" clearable  :readonly="ro.jiajucailiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家具材料" prop="jiajucailiao">
              <el-input v-model="ruleForm.jiajucailiao" 
                placeholder="家具材料" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="家具详情" prop="jiajuxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiajuxiangqing" label="家具详情" prop="jiajuxiangqing">
                    <span v-html="ruleForm.jiajuxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jiajubianhao'){
            this.ruleForm.jiajubianhao = obj[o];
	    this.ro.jiajubianhao = true;
            continue;
          }
          if(o=='jiajumingcheng'){
	    ...
	    this.ro.jiajuleixing = true;
          ...
          if(o=='jiajupinpai'){
            this.ruleForm.jiajupinpai = obj[o];
	    this.ro.jiajupinpai = true;
            continue;
          }
          if(o=='jiajuguige'){
            this.ruleForm.jiajuguige = obj[o];
	    this.ro.jiajuguige = true;
            continue;
          }
          if(o=='jiajutupian'){
	    ...
	    this.ro.jiajutupian = true;
          ...
          if(o=='jiajuyanse'){
            this.ruleForm.jiajuyanse = obj[o];
	    this.ro.jiajuyanse = true;
            continue;
          }
          if(o=='jiajucailiao'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/jiajuleixing/jiajuleixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.jiajuleixingOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.jiajuxiangqing = this.ruleForm.jiajuxiangqing.replace(reg,'../../../springbooth4q2o/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
